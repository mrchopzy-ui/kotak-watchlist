...
index f628f2304d21233ccc33ac49f8fe776dcee25848..772148338d23355d43ef56887fbdc76c5517fb76 100644
--- a/app.py
+++ b/app.py
@@ -1,169 +1,181 @@
...
-SESSION = {}
+SESSION = {"base": None, "login_error": None}
 SCRIPS = []
...
+
+def can_login():
+    return all([ACCESS_TOKEN, MOBILE, USER_ID, MPIN, TOTP_SECRET])
+
+if can_login():
+    login()
+else:
+    SESSION["login_error"] = "Missing Kotak API credentials."
